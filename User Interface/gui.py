...
tcp_null_scan_rb = Radiobutton(port_tab, text = "TCP NULL Scan", variable = scan_mode, value = 2,command = toggle_other).grid(row = 4, column = 0, sticky = W,padx = 2)
...
xmas_scan_rb = Radiobutton(port_tab, text = "TCP Xmas Scan", variable = scan_mode, value = 4,command = toggle_other).grid(row = 5, column = 0, sticky = W,padx = 2)
...
tcp_window_scan_rb = Radiobutton(port_tab, text = "TCP Window Scan", variable = scan_mode, value = 6,command = toggle_other).grid(row = 6, column = 0, sticky = W,padx = 2)
...
cwr_flag = IntVar()
ns_flag = IntVar()
Checkbutton(custom_frame, text = "ACK", variable = ack_flag).grid(row = 0, column = 0, padx = 2)
Checkbutton(custom_frame, text = "FIN", variable = fin_flag).grid(row = 1, column = 0, padx = 2)
...
src_port_label = Label(port_tab, text = 'Source Port').grid(column = 0, row = 9, sticky = W,pady = 1, padx = 2)
src_port = Entry(port_tab)
src_port.grid(column = 1, row = 9,pady = 1)

scan_button = Button(port_tab, text = 'Scan', command = scan).grid(column = 0, row = 10, sticky = W, pady = 2, padx = 6)
...
response_text.grid(column = 0, row = 11, columnspan = 2, padx = 6)
...
net_scan_mode.set(0)
arp_scan_rb = Radiobutton(net_tab, text = "ARP Scan", variable = net_scan_mode, value = 0).grid(row = 2, column = 0, sticky = W, padx = 2)
arp_scan_rb = Radiobutton(net_tab, text = "ICMP Scan", variable = net_scan_mode, value = 1).grid(row = 3, column = 0, sticky = W, padx = 2)
scan_button_net = Button(net_tab, text = 'Scan', command = net_scan).grid(column = 0, row = 4,sticky = W, padx = 6)
reset_button_net = Button(net_tab, text = 'Reset', command = reset_net).grid(column = 0, row = 4)
response_entry = Text(net_tab, width = 50)
response_entry.grid(column = 0, row = 6,sticky = W,  padx = 6)
